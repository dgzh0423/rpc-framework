    ...
    public RpcResponse doTolerant(Map<String, Object> context, Exception e) {
        ...
        for (ServiceMetaInfo serviceMetaInfo : serviceMetaInfoList) {
            ...
            try {
                ...
                // 如果重试再失败，继续重试下一个
                log.error("FailOverTolerantStrategy doTolerant {} retry fail", serviceMetaInfo);
            }
        }
        // 所有服务都重试失败
        throw new RuntimeException("FailOverTolerantStrategy doTolerant all service nodes retry fail");
    }
}